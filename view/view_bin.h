#ifndef VIEW_VIEW_BIN_H
#define VIEW_VIEW_BIN_H
...
public:
    ...
    void Materialize(std::unique_ptr<ViewBinHolder> &vbh, size_t root_degree)
    {
        Timer timer;
        timer.StartTimer();
...
#pragma omp parallel for num_threads(thread_num_)
        ...
        // std::cout << "=============" << std::endl;
        // for(ui i = new_row_ptrs[0]; i < new_row_ptrs[1]; ++i)
        // {
        //     std::cout << new_cols[i] << " ";
        // }
        // std::cout << std::endl;
